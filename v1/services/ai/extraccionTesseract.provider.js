...
// OCR + posible descarga de datos de idioma puede tardar más que una
// llamada de red común; le damos más margen que a Gemini/Groq (8s).
const TIMEOUT_MS = 15000;

/**
 * Corre Tesseract en un proceso hijo aislado (ver tesseractWorkerProcess.js
 * para el motivo). Si el hijo responde con un resultado, se resuelve. Si el
 * hijo crashea, se cuelga, o termina sin avisar, se rechaza — pero el
 * proceso PADRE (el servidor Express) nunca se ve afectado.
 */
export const extraerDatos = (imageUrl) => {
    return new Promise((resolve, reject) => {
        const child = fork(WORKER_SCRIPT, [], { silent: true });
        let resuelto = false;
